                    ...
                    if ('oxy_mega_columns' === $menu_item->object) {
                        ...
                        if ('on' === $oxy_widget) {
                            register_sidebar(array(
                                ...
                                'name'          => esc_html__('Menu', 'lambda-admin-td') . ' - ' . $menu_item->title,
    ...
    public function wp_ajax_oxy_save_menu()
    {
        ...
        if (0 == $nav_menu_selected_id) {
            ...
            if ($new_menu_title) {
                ...
                $messages[] = '<div id="message" class="error"><p>' . esc_html__('Please enter a valid menu name.', 'lambda-admin-td') . '</p></div>';
            }
