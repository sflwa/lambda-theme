...
$special_option = array(
    ...
    'type'    => 'select',
    'options' => array(
        ''                    => esc_html__('Normal Menu', 'lambda-admin-td'),
        'divider'             => esc_html__('Divider', 'lambda-admin-td'),
        'nav-highlight'       => esc_html__('Button Menu', 'lambda-admin-td'),
        'nav-highlight-ghost' => esc_html__('Bordered Button Menu', 'lambda-admin-td'),
        'disabled'            => esc_html__('Disabled Menu', 'lambda-admin-td')
    ),
    'default' => ''
);
...
<p class="field-icon oxy-modal description-wide">
    <label for="edit-menu-item-modal-<?php echo esc_attr($item_id); ?>">
...
<p class="field-url oxy_label description-thin">
    <label for="edit-menu-item-oxy_label-<?php echo esc_attr($item_id); ?>">
        <?php _e('Extra menu label','lambda-admin-td'); ?>
        <input type="text" id="edit-menu-item-oxy_label-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-oxy_label" name="menu-item-oxy_label[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr($item->oxy_label); ?>" />
...
<p class="field-icon oxy-label-type description-thin">
    <label for="edit-menu-item-label_type-<?php echo esc_attr($item_id); ?>">
