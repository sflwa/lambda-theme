...
class OxygennaQuickUpload
{
    ...
    public function select_images_page($post_type, $options)
    {
        ...
        if (!current_user_can('upload_files')) {
            wp_die(esc_html__('You do not have permission to upload files.', 'lambda-admin-td'));
        }
        ...
        if (isset($action) && $action == 'edit' && !$ID) {
            wp_die(esc_html__('You are not allowed to be here', 'lambda-admin-td'));
        }
        ...
        $title = esc_html__('Upload New Media', 'lambda-admin-td');
        ...
        <?php submit_button(esc_html__('Use these images', 'lambda-admin-td'), 'button savebutton', 'save'); ?>
        </form>
        </div>
...
?>
                ...
                <div id="poststuff">
                    ...
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content">
                            ...
                            <?php submit_button(esc_html__('Save', 'lambda-admin-td') . ' ' .$options['item_plural']); ?>
                        </div>
                    </div>
                </div>
            </form>
    ...
    public function build($post_type, $options)
    {
        ...
        echo '<div id="message" class="updated fade"><p><strong>' . sprintf(esc_html__('Created %d %s', 'lambda-admin-td'), count($_POST['media_attachment_id']), $options['item_plural']) . '</strong></p></div>';
    }
}
