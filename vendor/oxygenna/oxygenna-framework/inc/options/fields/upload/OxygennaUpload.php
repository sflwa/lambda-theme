...
class OxygennaUpload extends OxygennaOption
{
    ...
    private function create_option($value, $url)
    {
        ...
        $option .= '<input type="button" class="oxy-set-image" data-frame-title="' . esc_html__('Select Image', 'lambda-admin-td') . '" data-frame-button-text="' . esc_html__('Select Image', 'lambda-admin-td') . '"  value="' . esc_html__('Set Image', 'lambda-admin-td') . '"/>';
        $option .= '<input type="button" class="oxy-remove-image" value="' . esc_html__('Remove Image', 'lambda-admin-td') . '" style="' . $hide_preview . '"/>';
        $option .= '</div>';
