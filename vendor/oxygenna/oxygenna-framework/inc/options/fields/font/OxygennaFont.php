...
class OxygennaFont extends OxygennaSelect
{
    ...
    public function load_select_data($database = null)
    {
        ...
        $data['system_fonts'] = array(
            'optgroup' => esc_html__('System Fontstacks', 'lambda-admin-td'),
            'options' => array()
        );
        ...
        if (false !== $typekit) {
            foreach ($typekit as $kit) {
                $key = $kit['kit']['id'];
                $data[$key] = array(
                    'optgroup' => esc_html__('TypeKit', 'lambda-admin-td') . ' - ' . $kit['kit']['name'] . ' Kit',
                    'options' => array()
                );
        ...
        if (!empty($google_fonts)) {
            $data['google_fonts'] = array(
                'optgroup' => esc_html__('Google Web Fonts', 'lambda-admin-td'),
                'options' => array()
            );
