...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="u-column col-md-6 col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> col-<?php echo ( ( $oldcol = $oldcol * -1 ) < 0 ) ? 1 : 2; ?> woocommerce-Address">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="edit btn btn-primary"><?php _e( 'Edit', 'woocommerce' ); ?></a>
			</div>
		</div>
	</div>
