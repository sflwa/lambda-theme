...
<section class="section section-commerce">
	...
	<?php do_action( 'woocommerce_before_cart' ); ?>
			...
			<?php wc_print_notices(); ?>
				<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
					...
					<div class="table-responsive">
						<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents table element-bottom-20" cellspacing="0">
							<thead>
								<tr>
					...
					<div class="row">
						...
						<div class="col-md-3 element-bottom-20">
							<button type="submit" class="button btn btn-info btn-block" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>">
								<i class="fa fa-refresh"></i>
								<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>
							</button>
                        </div>
                        <div class="col-md-3 element-bottom-20" >
							<button type="submit" class="button btn btn-success checkout-button alt wc-forward btn-block" name="proceed" value="true">
		...
		<div class="row element-bottom-20">
			...
			<div class="col-md-6 cart-collaterals">
