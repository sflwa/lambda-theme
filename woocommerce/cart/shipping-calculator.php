...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<h2><a href="#" class="btn btn-info btn-block shipping-calculator-button">%s &nbsp;<i class="fa fa-truck fa-fw"></i></a></h2>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	...
	<section class="shipping-calculator-form" style="display:none;">
			...
			<p class="form-row form-row-wide" id="calc_shipping_state_field">
				<?php
					...
					if ( is_array( $states ) && empty( $states ) ) {
						?>
						<input type="hidden" class="form-control" name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php esc_attr_e( 'State / County', 'woocommerce' ); ?>" />
						<?php
					// Dropdown Input
					} elseif ( is_array( $states ) ) {

						?><div class="form-group">
							<select name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php esc_attr_e( 'State / County', 'woocommerce' ); ?>" class="form-control state_select">
		...
		<button type="submit" name="calc_shipping" value="1" class="btn btn-success button"><?php esc_html_e( 'Update totals', 'woocommerce' ); ?></button>
