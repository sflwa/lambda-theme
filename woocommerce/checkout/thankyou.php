...
<section class="section section-commerce">
	...
	<div class="container element-top-50 element-bottom-50 woocommerce-order">
		...
		<?php if ( $order ) :
			...
			<?php else : ?>
				...
				<p class="alert alert-success woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'woocommerce' ), $order ); ?></p>
