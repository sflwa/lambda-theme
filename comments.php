...
<div class="comments padded" id="comments">
    <div class="comments-head">
        <h3>
            <?php
                printf( _n( '1 comment', '%s comments', get_comments_number(), 'lambda-td' ), number_format_i18n( get_comments_number() ) );
            ?>
        </h3>
        <small>
    ...
    <nav id="comment-nav-below" class="navigation" role="navigation">
        <ul class="pager">
        <li class="previous"><?php previous_comments_link( esc_html__( '&larr; Older', 'lambda-td' ) ); ?></li>
        <li class="next"><?php next_comments_link( esc_html__( 'Newer &rarr;', 'lambda-td' ) ); ?></li>
        </ul>
    </nav>
