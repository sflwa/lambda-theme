        ...
        <div class="figure-overlay-container">
            <?php if( $overlay === 'caption' || $overlay === 'strip' ) : ?>
                <div class="figure-caption">
                    <h3 class="figure-caption-title bordered bordered-small"><?php echo esc_html($caption_title); ?></h3>
                    <p class="figure-caption-description"><?php echo esc_html($caption_text); ?></p>
                </div>
            ...
            <?php elseif( $overlay === 'buttons' || $overlay === 'buttons_only' ) : ?>
                <div class="figure-caption">
                    <?php if( $overlay === 'buttons' ) : ?>
                        <h4 class="figure-caption-title element-small-bottom bordered bordered-small"><?php echo esc_html($caption_title); ?></h4>
                    <?php endif; ?>
                    <p class="figure-caption-description">
                        <a href="<?php echo esc_url($magnific_link_url); ?>" class="btn btn-primary <?php echo esc_attr(implode( ' ', $magnific_link_classes )); ?> image-all" data-links="<?php echo implode( ',', $gallery_images ); ?>"><?php echo esc_html($button_text_zoom); ?></a>
                        <a href="<?php echo esc_url($link); ?>" class="btn btn-primary" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($button_text_details); ?></a>
                    </p>
                </div>
            <?php endif; ?>
        </div>
