		...
		<?php if( 'vc_accordion_tab' == $matches[2][$i] ) {
		    ...
		    <div class="panel panel-<?php echo esc_attr($type); ?>">
		        <div class="panel-heading">
		            <a href="#<?php echo esc_attr($group_id); ?>" class="accordion-toggle collapsed" data-parent = "#<?php echo esc_attr($id); ?>" data-toggle="collapse" ><?php echo esc_html($accordion_atts['title']); ?></a>
		        </div>
		        <div id="<?php echo esc_attr($group_id); ?>" class="panel-collapse collapse <?php echo esc_attr($open_close_class); ?>">
