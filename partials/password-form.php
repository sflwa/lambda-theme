        ...
        <div class="col-md-8 col-md-push-2 text-default small-screen-default">
            ...
            <form action="<?php echo esc_url(site_url('wp-login.php?action=postpass', 'login_post')); ?>" method="post">
                <div class="form-group">
                    <label for="<?php echo esc_attr($label); ?>"><?php _e('Password:', 'lambda-td'); ?></label>
                    <input class="form-control" name="post_password" id="<?php echo esc_attr($label); ?>" type="password" size="20" maxlength="20" />
                </div>
