...
class OxyWidgetSocial extends OxygennaWidget
{
    ...
    public function __construct()
    {
        $widget_options = array(
            'description' => esc_html__('Social Icons Widget', 'lambda-admin-td'),
            'classname' => 'widget_social'
        );
        parent::__construct('social-options.php', false, $name = THEME_NAME . ' - ' . esc_html__('Social Icons Widget', 'lambda-admin-td'), $widget_options);
    }
