...
class OxyCustomRecentPostsWidget extends WP_Widget_Recent_Posts
{
    ...
    public function widget($args, $instance)
    {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Recent Posts', 'lambda-td') : $instance['title'], $instance, $this->id_base);
        ...
        if ($r->have_posts()) {
            ...
            <?php while($r->have_posts()) : $r->the_post(); ?>
                ...
                <li class="clearfix">
                    <div class="post-icon">
                        <a href="<?php echo esc_url($post_link); ?>" title="<?php the_title(); ?>">
                    ...
                    <a href="<?php echo esc_url($post_link); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a>
...
class OxyCustomArchivesWidget extends WP_Widget_Archives
{
    ...
    public function widget($args, $instance)
    {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Archives', 'lambda-td') : $instance['title'], $instance, $this->id_base);
        ...
        <select name="archive-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'>
            <option value=""><?php echo esc_attr(esc_html__('Select Month', 'lambda-td')); ?></option>
