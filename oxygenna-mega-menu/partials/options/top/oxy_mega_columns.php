...
<p class="field-widget oxy-widget description-wide">
    <label for="edit-menu-item-oxy-widget-<?php echo esc_attr($item_id); ?>">
...
<p class="field-url oxy_col_url description-wide">
    <label for="edit-menu-item-oxy_col_url-<?php echo esc_attr($item_id); ?>">
        <?php _e('Column Title URL', 'lambda-admin-td'); ?><br />
        <input type="text" id="edit-menu-item-oxy_col_url-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-oxy_col_url" name="menu-item-oxy_col_url[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr($item->oxy_col_url); ?>" />
